...
import com.reactlibrary.rendering.CanvasQuad;
...
public class VideoUiView extends LinearLayout {
    ...
    public static VideoUiView createForOpenGl(Context context, ViewGroup parent, CanvasQuad quad) {
        ...
        VideoUiView view = (VideoUiView) View.inflate(context, R.layout.view_video_ui, null);
    ...
    public void onFinishInflate() {
                ...
                new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (mediaPlayer.isPlaying()) {
                            mediaPlayer.pause();
                            playPauseToggle.setImageResource(R.drawable.ic_play_arrow);
                            playPauseToggle.setContentDescription("play");
                        } else {
                            mediaPlayer.start();
                            playPauseToggle.setImageResource(R.drawable.ic_pause);
        ...
        final ImageButton muteButton = (ImageButton) findViewById(R.id.mute_button);
    ...
    public void setVrIconClickListener(OnClickListener listener) {
        /* for use if we choose to implement this */
    }
